...
const en: Dict = {
  ...
  "ts.turnClock": "Turn clock",
  "ts.clockOff": "Off",
  "ts.clockOffSub": "No time limit",
  "ts.clockMoveSub": "Seconds per move — auto-plays a safe move if you run out",
  "ts.clockChessSub": "Total time per player — you lose on time (chess clock)",
...
const ka: Dict = {
  ...
  "ts.turnClock": "სვლის საათი",
  "ts.clockOff": "გამორთული",
  "ts.clockOffSub": "დროის ლიმიტის გარეშე",
  "ts.clockMoveSub": "წამი თითო სვლაზე — დროის ამოწურვისას ავტომატურად ითამაშებს უსაფრთხო სვლას",
  "ts.clockChessSub": "თითოეული მოთამაშის საერთო დრო — დროზე აგებთ (ჭადრაკის საათი)",
